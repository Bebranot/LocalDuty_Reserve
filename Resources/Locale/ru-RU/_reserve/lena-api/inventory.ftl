...
reserve-inventory-empty = Ваш инвентарь пуст.
reserve-inventory-error-not-found = Не удалось найти данные вашего аккаунта. Попробуйте переподключиться.
reserve-inventory-error-fetch = Не удалось загрузить инвентарь. Попробуйте позже.
reserve-inventory-use-button = Использовать
